...
- Reproducible repository defect: use the [bug report form](https://github.com/yehyakin/codex-prove/issues/new?template=bug_report.yml).
- Focused improvement proposal: use the [feature request form](https://github.com/yehyakin/codex-prove/issues/new?template=feature_request.yml).
